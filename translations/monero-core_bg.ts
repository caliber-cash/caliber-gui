...
<context>
    ...
    <message>
        ...
        <translation>За да намерите отдалечен нод, напишете &apos;Caliber remote node&apos; в любимата си търсачка. Моля уверете се, че нодът се поддържа от сигурни трети лица.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>За всяка транзакция, се удържа малка трансферна такса. Тази опция ви позволява да добавите допълнителна сума, като процент от таксата, към ваша транзакция за да подпомагате развитието на Монеро. Например: 50% автоматично дарение взима трансферна такса от 0.005 CAL и добавя 0.0025 CAL за подпомагане развитието на Монеро.</translation>
    </message>
    <message>
...
Spending address index: </source>
    ...
    <message>
        ...
        <translation>Има нова версия на caliber-wallet-gui: %1&lt;br&gt;%2</translation>
    </message>
    <message>
