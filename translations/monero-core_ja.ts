...
<context>
    ...
    <message>
        ...
        <translation>取引には少額の手数料がかかります。このオプションはその手数料に加えて、手数料の何パーセントかをCaliberの開発チームへの寄付として支払うことを許可します。例えば自動寄付の割合が50%で、取引の手数料が0.005 XMRであった場合、0.0025 XMRが開発チームへの寄付として取引に上乗せされます。</translation>
    </message>
    <message>
